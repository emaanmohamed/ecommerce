        ...
        <header class="with-background" style="background-color: #535353">
            ...
            <div class="hero container">
                ...
                <div class="hero-image">
                    <img src="{{url('img/macbook-pro-laravel.png')}}" alt="hero image">
                </div> <!-- end hero-image -->
            </div> <!-- end hero -->
        </header>
            ...
            <div class="container">
                ...
                <div class="blog-posts">
                    <div class="blog-post" id="blog1">
                        <a href="#"><img src="{{url('/img/blog1.png')}}" alt="Blog Image"></a>
                    ...
                    <div class="blog-post" id="blog2">
                        <a href="#"><img src="{{url('/img/blog2.png')}}" alt="Blog Image"></a>
                        <a href="#"><h2 class="blog-title">Blog Post Title 2</h2></a>
                        <div class="blog-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi, tenetur numquam ipsam reiciendis.</div>
                    </div>
                    <div class="blog-post" id="blog3">
                        <a href="#"><img src="{{url('/img/blog3.png')}}" alt="Blog Image"></a>
